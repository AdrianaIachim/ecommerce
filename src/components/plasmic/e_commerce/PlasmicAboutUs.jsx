...
import sty from "./PlasmicAboutUs.module.css"; // plasmic-import: SkWOoe9ASwpis-/css
...
import nanTalkwebp4Rq3Vlf8JSeMe from "./images/nanTalkwebp.webp"; // plasmic-import: _4Rq3Vlf8jSeME/picture
import teamwebpVneIcz59Aleo2B from "./images/teamwebp.webp"; // plasmic-import: vneIcz59Aleo2b/picture
            ...
            >
              {true ? (
                ...
                >
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.column__xqy7T)}
                    >
                      <p.PlasmicImg
                        alt={""}
                        className={classNames(sty.img__qbqcq)}
                        displayHeight={
                          hasVariant(globalVariants, "screen", "mobile")
                            ? "400px"
                            : "500px"
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.column___7E2Yv)}
                    >
                      <h2
                        className={classNames(
                          projectcss.all,
                ...
                <div className={classNames(projectcss.all, sty.freeBox__bfggB)}>
                  ...
                  >
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.column__k7Tu)}
                    >
                      <h2
                        className={classNames(
                          projectcss.all,
                    ...
                    >
                      <p.PlasmicImg
                        alt={""}
                        className={classNames(sty.img__sx8Ac)}
                        displayHeight={
                          hasVariant(globalVariants, "screen", "mobile")
                            ? "400px"
                            : "500px"
